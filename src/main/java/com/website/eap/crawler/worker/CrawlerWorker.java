package com.website.eap.crawler.worker;

import com.website.eap.crawler.fetcher.PageFetcher;
import com.website.eap.crawler.hadler.ContentHandler;
...
import com.website.eap.crawler.parser.ContentParser;
import com.website.eap.crawler.queue.UrlQueue;
import com.website.eap.crawler.storage.DataStorage;
		...
		public void run() {
			...
			while(!UrlQueue.isEmpty()){
				...
				if(fetchedPage.getType() ==CrawlerParams.FETCHEDPAGETYPE_JSON){
                    ...
                    List<MovieEntity> movieEntityList=parser.parseJson(fetchedPage);
                    for(MovieEntity movieEntity:movieEntityList){
                        store.store(movieEntity);
                    }
